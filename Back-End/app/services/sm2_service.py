...
class SM2UpdateSnapshot:
    ...
    new_correct_streak: int

    new_wrong_streak: int
...
def apply_modified_sm2(
    ...
    *,
    ...
    old_correct_streak = int(word.correctStreak or 0)

    old_wrong_streak = int(word.wrongStreak or 0)
    ...
    if quality >= 3:
        ...
        new_correct_streak = old_correct_streak + 1
        ...
        new_wrong_streak = old_wrong_streak + 1

        if new_wrong_streak >= 3 or quality == 0:

            new_repeats = 0

        elif new_wrong_streak >= 2:
    ...
    elif new_wrong_streak >= 3:

        new_status = "hard"

    elif new_repeats == 0:

        new_status = "learning" if quality < 3 else "new"
    ...
    learning_insight = _learning_insight(
        ...
        wrong_streak=new_wrong_streak,

    )

    smart_action = _smart_action(status=new_status, wrong_streak=new_wrong_streak)
    ...
    return SM2UpdateSnapshot(
        ...
        new_correct_streak=new_correct_streak,

        new_wrong_streak=new_wrong_streak,
