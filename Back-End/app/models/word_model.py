...
class WordTranslation(Base):
    ...
    provider = Column(String, default="fallback", nullable=False)
...
class WordExample(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("word_id", "sentence_en", name="uq_word_example_sentence"),

        Index("ix_word_examples_word_id", "word_id"),
